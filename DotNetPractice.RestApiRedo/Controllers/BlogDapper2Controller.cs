...
namespace DotNetPractice.RestApiRedo.Controllers
{
    ...
    public class BlogDapper2Controller : ControllerBase
    {
        ...
        private readonly IDbConnection _connection = new SqlConnection(ConnectionString.sqlConnectionStringBuilder.ConnectionString);
        ...
        public IActionResult GetBlogs()
        {
            ...
            List<BlogModel> lst = _dapperService.QueryToList<BlogModel>(query).ToList();
            return Ok(lst);
        }
